...
stackblk sr1(deque<stackblk> &stack) {
...
stackblk sr2(deque<stackblk> &stack) {
...
stackblk sr3(deque<stackblk> &stack) {
...
stackblk sr4(deque<stackblk> &stack) {
    auto exp = stack.back().u.exp;
...
stackblk sr5(deque<stackblk> &stack) {
    auto id = stack.back().u.id;
...
stackblk sr6(deque<stackblk> &stack) {
...
stackblk sr7(deque<stackblk> &stack) {
    auto digits = stack.back().u.digits;
...
stackblk sr8(deque<stackblk> &stack) {
...
stackblk sr0(deque<stackblk> &stack) {
    printf("accepted\n");
    auto entry = stack.front();
    stack.pop_back();
    return entry;
}
reduce_fun sreduce[NUM_RULES] = {
    sr0,
    sr1,
    sr2,
    sr3,
